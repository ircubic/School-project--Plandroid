...
especially focus on automated schedule negotiation while planning events.
...
In the first\marginpar{Remove first if we don't do more design phases} design
phase, I created a functional prototype of the application in the form of an
Android application. This application was hard-coded to be used with the
